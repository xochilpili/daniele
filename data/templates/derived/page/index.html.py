...
_magic_number = 9
_modified_time = 1386336563.684055
_enable_loop = True
_template_filename = '/Users/xochilpili/Documents/Develop/python/pylons/DanieleChallenge/danielechallenge/templates/derived/page/index.html'
_template_uri = '/derived/page/index.html'
...
def render_body(context,**pageargs):
    ...
    try:
        ...
        # SOURCE LINE 55
        __M_writer(escape(result))
        __M_writer(u'\n\t<h1>Challenge demo</h1>\n\t<p>This is the first challenge of many (i hope)...</p>\n</body>\n</html>\n')
        return ''
    finally:
